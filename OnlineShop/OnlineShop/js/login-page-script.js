...
if (form.action.substring(form.action.lastIndexOf("/") + 1) === "registration.php") {
    elems = {
        email : [document.querySelector("input[type='email']"), document.querySelector("input[type='email'] + span.error"), {
            valueMissing: "Почта обязательна",
            typeMismatch: "Значением должен быть почтовый адрес",
            tooLong: `Почта должна быть короче ${document.querySelector("input[name='login']").maxLength} символов`
        }, validate],
        login : [document.querySelector("input[name='login']"), document.querySelector("input[name='login'] + span.error"), {
            ...
            tooShort: `Логин должен быть хотя-бы ${document.querySelector("input[name='login']").minLength} символов`,
            tooLong: `Логин должен быть короче ${document.querySelector("input[name='login']").maxLength} символов`
        }, validate],
    ...
    elems = {
        login : [document.querySelector("input[name='login']"), document.querySelector("input[name='login'] + span.error"), {
            valueMissing: "Логин обязателен",
            patternMismatch: "Допустимые символы [a-zA-Z0-9_-]",
            tooShort: `Логин должна быть хотя-бы ${document.querySelector("input[name='login']").minLength} символов.`
        }, validate],
        password : [document.querySelector("input[name='password']"), document.querySelector("input[name='password'] + span.error"), {
            valueMissing: "Куда без пароля?",
            tooShort: `Пароль должен быть хотя-бы ${document.querySelector("input[name='password']").minLength} символов.`
